...
function loadCaptcha() {
    api.get(
        ...
        admin.value.jwt = result.message
        ...
        if (valid) {
            adminApi.login(admin.value).then(result => {
                if (result.code == 200) {
                    ...
                    adminStore.changeAdmin(result.data)
        ...
        <div class="login-form">
            <div style="width: 500px;margin: 0 auto;margin-top: 20px;font-size: 24px;border-bottom: 5px solid ;">
                <el-row class="row-style">
                    ...
                    <el-col :span="12">管理员登录</el-col>
                </el-row>
            </div>

            <div class="real-form">
                <el-form :model="admin" label-width="80px" ref="AdminLoginForm" :rules="rules">
                    <el-form-item label="邮箱" prop="email">
                        <div class="icon-wrapper"><el-icon><User /></el-icon></div>
                        <el-input v-model="admin.email" placeholder="请输入邮箱" class="input-style"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="验证码" style="margin: 0px;" prop="captcha">
                        ...
                        <el-row style="width: 300px;height: 30px;">
                            <el-col :span="16">
                                <el-input v-model="admin.captcha" placeholder="请输入验证码"
                    ...
                    <div class="remember">
                        <span>
                            <el-checkbox v-model="admin.remember" label="记住密码" size="large" value=1 />
                        </span>
                    </div>
